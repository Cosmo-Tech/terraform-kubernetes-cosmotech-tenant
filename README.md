...
| <a name="module_create-copilot-api"></a> [create-copilot-api](#module\_create-copilot-api) | ./create-copilot-api | n/a |
...
| <a name="input_acr_login_server_url"></a> [acr\_login\_server\_url](#input\_acr\_login\_server\_url) | n/a | `string` | n/a | yes |
...
| <a name="input_app_path"></a> [app\_path](#input\_app\_path) | Copilot API app path | `string` | n/a | yes |
...
| <a name="input_copilot_api_ai_provider"></a> [copilot\_api\_ai\_provider](#input\_copilot\_api\_ai\_provider) | Cloud provider for the AI service. | `string` | n/a | yes |
| <a name="input_copilot_api_azure_bot_app_id"></a> [copilot\_api\_azure\_bot\_app\_id](#input\_copilot\_api\_azure\_bot\_app\_id) | Azure Bot Application ID. | `string` | n/a | yes |
| <a name="input_copilot_api_azure_bot_directline_secret"></a> [copilot\_api\_azure\_bot\_directline\_secret](#input\_copilot\_api\_azure\_bot\_directline\_secret) | DirectLine secret for the Azure Bot. | `string` | n/a | yes |
| <a name="input_copilot_api_azure_bot_password"></a> [copilot\_api\_azure\_bot\_password](#input\_copilot\_api\_azure\_bot\_password) | Password for the Azure Bot Application. | `string` | n/a | yes |
| <a name="input_copilot_api_azure_open_ai_api_key"></a> [copilot\_api\_azure\_open\_ai\_api\_key](#input\_copilot\_api\_azure\_open\_ai\_api\_key) | API key for Azure Open AI. | `string` | n/a | yes |
| <a name="input_copilot_api_azure_open_ai_api_type"></a> [copilot\_api\_azure\_open\_ai\_api\_type](#input\_copilot\_api\_azure\_open\_ai\_api\_type) | Type of API used for Azure Open AI. | `string` | n/a | yes |
| <a name="input_copilot_api_azure_open_ai_api_version"></a> [copilot\_api\_azure\_open\_ai\_api\_version](#input\_copilot\_api\_azure\_open\_ai\_api\_version) | API version for Azure Open AI. | `string` | n/a | yes |
| <a name="input_copilot_api_azure_open_ai_endpoint"></a> [copilot\_api\_azure\_open\_ai\_endpoint](#input\_copilot\_api\_azure\_open\_ai\_endpoint) | Endpoint URL for Azure Open AI. | `string` | n/a | yes |
| <a name="input_copilot_api_chart_package_version"></a> [copilot\_api\_chart\_package\_version](#input\_copilot\_api\_chart\_package\_version) | n/a | `string` | n/a | yes |
| <a name="input_copilot_api_chunk_overlap"></a> [copilot\_api\_chunk\_overlap](#input\_copilot\_api\_chunk\_overlap) | Number of overlapping tokens between chunks. | `number` | n/a | yes |
...
| <a name="input_copilot_api_helm_repository"></a> [copilot\_api\_helm\_repository](#input\_copilot\_api\_helm\_repository) | n/a | `string` | n/a | yes |
| <a name="input_copilot_api_index_name"></a> [copilot\_api\_index\_name](#input\_copilot\_api\_index\_name) | Name of the Azure AI Search index (e.g., 'supply-chain' or 'assets'). | `string` | n/a | yes |
| <a name="input_copilot_api_is_vector_store_local"></a> [copilot\_api\_is\_vector\_store\_local](#input\_copilot\_api\_is\_vector\_store\_local) | Flag indicating whether to build a local vector store (using FAISS) instead of using Azure AI Search. | `bool` | n/a | yes |
| <a name="input_copilot_api_kusto_cluster_url"></a> [copilot\_api\_kusto\_cluster\_url](#input\_copilot\_api\_kusto\_cluster\_url) | URL of the Azure Data Explorer (Kusto) cluster. | `string` | n/a | yes |
| <a name="input_copilot_api_kusto_database"></a> [copilot\_api\_kusto\_database](#input\_copilot\_api\_kusto\_database) | Name of the Azure Data Explorer database. | `string` | n/a | yes |
| <a name="input_copilot_api_llm_deployment_name"></a> [copilot\_api\_llm\_deployment\_name](#input\_copilot\_api\_llm\_deployment\_name) | Name of the LLM deployment for generating natural language responses. | `string` | n/a | yes |
| <a name="input_copilot_api_max_token"></a> [copilot\_api\_max\_token](#input\_copilot\_api\_max\_token) | Maximum number of tokens for LLM responses. | `number` | n/a | yes |
| <a name="input_copilot_api_mode"></a> [copilot\_api\_mode](#input\_copilot\_api\_mode) | Application mode: either 'supply-chain' or 'assets'. | `string` | n/a | yes |
| <a name="input_copilot_api_organization"></a> [copilot\_api\_organization](#input\_copilot\_api\_organization) | Organization ID for Cosmo Tech. | `string` | n/a | yes |
| <a name="input_copilot_api_port"></a> [copilot\_api\_port](#input\_copilot\_api\_port) | Port on which the API will run. | `number` | n/a | yes |
| <a name="input_copilot_api_retrieved_document_nb"></a> [copilot\_api\_retrieved\_document\_nb](#input\_copilot\_api\_retrieved\_document\_nb) | Number of documents to retrieve from the search service. | `number` | n/a | yes |
| <a name="input_copilot_api_search_api_key"></a> [copilot\_api\_search\_api\_key](#input\_copilot\_api\_search\_api\_key) | API key for Azure AI Search. | `string` | n/a | yes |
| <a name="input_copilot_api_search_endpoint_url"></a> [copilot\_api\_search\_endpoint\_url](#input\_copilot\_api\_search\_endpoint\_url) | Endpoint URL for Azure AI Search. | `string` | n/a | yes |
| <a name="input_copilot_api_streaming"></a> [copilot\_api\_streaming](#input\_copilot\_api\_streaming) | Flag to enable streaming responses from the LLM. | `bool` | n/a | yes |
| <a name="input_copilot_api_temperature"></a> [copilot\_api\_temperature](#input\_copilot\_api\_temperature) | Temperature parameter for the LLM (between 0 and 1). | `number` | n/a | yes |
| <a name="input_copilot_api_workspace"></a> [copilot\_api\_workspace](#input\_copilot\_api\_workspace) | Workspace ID for Cosmo Tech. | `string` | n/a | yes |
...
| <a name="input_cosmotech_api_helm_chart"></a> [cosmotech\_api\_helm\_chart](#input\_cosmotech\_api\_helm\_chart) | n/a | `string` | n/a | yes |
| <a name="input_cosmotech_api_helm_release_name"></a> [cosmotech\_api\_helm\_release\_name](#input\_cosmotech\_api\_helm\_release\_name) | n/a | `string` | n/a | yes |
| <a name="input_cosmotech_api_helm_repository"></a> [cosmotech\_api\_helm\_repository](#input\_cosmotech\_api\_helm\_repository) | n/a | `string` | n/a | yes |
...
| <a name="input_cosmotech_api_persistence_size"></a> [cosmotech\_api\_persistence\_size](#input\_cosmotech\_api\_persistence\_size) | n/a | `string` | n/a | yes |
| <a name="input_cosmotech_api_persistence_storage_class"></a> [cosmotech\_api\_persistence\_storage\_class](#input\_cosmotech\_api\_persistence\_storage\_class) | n/a | `string` | n/a | yes |
...
| <a name="input_create_copilot_api"></a> [create\_copilot\_api](#input\_create\_copilot\_api) | n/a | `bool` | n/a | yes |
