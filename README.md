...
| <a name="module_create-keycloak-realm"></a> [create-keycloak-realm](#module\_create-keycloak-realm) | ./create-keycloak-realm | n/a |
...
| <a name="input_keycloak_admin_password"></a> [keycloak\_admin\_password](#input\_keycloak\_admin\_password) | n/a | `string` | n/a | yes |
...
| <a name="input_valid_redirect_uri"></a> [valid\_redirect\_uri](#input\_valid\_redirect\_uri) | n/a | `list(string)` | <pre>[<br>  "/*"<br>]</pre> | no |
<!-- END_TF_DOCS -->