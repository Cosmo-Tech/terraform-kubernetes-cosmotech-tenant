...
| <a name="input_identity_provider"></a> [identity\_provider](#input\_identity\_provider) | n/a | <pre>object({<br>    code = string<br>    authorizationUrl = string<br>    tokenUrl = string<br>    defaultScopes = map(any)<br>    containerScopes = map(any)<br>    serverBaseUrl = string<br>    audience = string<br>    identity = object({<br>      clientId = string<br>      clientSecret = string<br>      tenantId = string<br>    })<br>  })</pre> | <pre>{<br>  "audience": "",<br>  "authorizationUrl": "",<br>  "code": "",<br>  "containerScopes": {},<br>  "defaultScopes": {},<br>  "identity": {<br>    "clientId": "",<br>    "clientSecret": "",<br>    "tenantId": ""<br>  },<br>  "serverBaseUrl": "",<br>  "tokenUrl": ""<br>}</pre> | no |
