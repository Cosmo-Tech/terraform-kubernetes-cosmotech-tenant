module "create-cosmotech-api-deployment" {
  source = "./create-tekton-cosmotech-api"

  count = var.deploy_cosmotech_api_tekton_pipline ? 1 : 0
  ...
  api_use_oci_registry          = var.api_use_oci_registry
  api_run_cypress_tests         = var.api_run_cypress_tests
  tekton_node_selector          = var.tekton_node_selector
